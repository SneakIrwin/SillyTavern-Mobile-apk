...
- On Android 8 and newer, a valid paired WebView automatically enters a minimal picture-in-picture continuity window when you switch apps so active streamed generation is not frozen with a hidden page. Pairing and error screens never auto-enter PiP.
